...
for(i in unique(human_named$individual)){
  ...
  df = subset_obj@meta.data[, c('Cell', 'harmony.wnn_res0.4_clusters')]
  
  meta_path = paste0('A:/CellPhoneDB 030225/',i,'/human_named_meta.tsv')
...
file_path = paste0('A:/CellPhoneDB 030225/',i,'/DEGs.tsv')
