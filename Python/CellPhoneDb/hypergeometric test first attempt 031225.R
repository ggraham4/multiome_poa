...
phyper(q = successes, m = all_successes_possible, n =  all_failures_possible, k = failures, lower.tail = F, log.p = F)
...
hypergeom_pair = function(signif_data, term){
  ...
  test = phyper(q = successes, m = all_successes_possible, n =  all_failures_possible, k = failures, lower.tail = F, log.p =F)
