...
results_dir   <- "C:/Users/Gabe/Desktop/Visium/parker_clusters_20/cell2location_map"
...
saveRDS(vis, file.path(visium_dir, "vis_better_barcodes_c2l05_projection_parker_2024_clusters20.rds"))
