...
vis <- readRDS(
"C:/Users/Gabe/Desktop/Visium/vis_better_barcodes_dissection_c2l05_projection_anatomical.rds"
)
## this way I dont have to worry about renaming barcodes or adding meta data

### Subset visium clusters to rgc###
DotPlot(vis, features = c("hmx3a",
                          'hmx2',
                          'hmx3b',
                          'gal',
                          'avp',
...
outdir <- "C:/Users/Gabe/Desktop/Visium/POA"
