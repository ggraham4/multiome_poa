...
newbornNeurons =(obj.obs['sub.cluster']=='9').values
neurons = (obj.obs['sub.cluster']!='9').values
...
export_folder = Path("C:/Users/Gabe/Desktop/multiome_poa/Classifying Newborn Neurons/output_9")
