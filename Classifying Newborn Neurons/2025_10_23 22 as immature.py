...
newbornNeurons =(obj.obs['sub.cluster']=='22').values
neurons = (obj.obs['sub.cluster']!='22').values
...
export_folder = Path("C:/Users/Gabe/Desktop/multiome_poa/Classifying Newborn Neurons/output_22")
...
for i, kind in enumerate(("observed", "shuffled")):
    ...
    df_pred_norm.to_parquet(
        export_folder
        / f"2025_10_23_{N_BOOT}_restarts_{kind}.parquet"
    )
    df_cmat_mean.to_parquet(
        export_folder
        / f"2025_10_23_again_{N_BOOT}_restarts_{kind}.parquet"
    )
