...
brown_data$Status <- ifelse(brown_data$Status =='D','I',brown_data$Status)
brown_data$Status <- ifelse(brown_data$Status =='E','LI',brown_data$Status)

brown_data$Status <- factor(brown_data$Status, levels = c('M','I','LI', 'NF','F'))
...
turquoise_data$Status <- as.character(turquoise_data$Status)
pairs(emmeans(turquoise_model, 'Status', by ='sub'), adjust ='none') 

turquoise_data$Status <- ifelse(turquoise_data$Status =='D','I',turquoise_data$Status)
turquoise_data$Status <- ifelse(turquoise_data$Status =='E','LI',turquoise_data$Status)

turquoise_data$Status <- factor(turquoise_data$Status, levels = c('M','I','LI', 'NF','F'))
