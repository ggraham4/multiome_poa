...
clusters <- unique(obj$res0.8_50nn_40PC_45LSI)
...
Idents(new_obj) <- 'res0.8_50nn_40PC_45LSI'

DimPlot(new_obj)
FeaturePlot(new_obj, 'CCK') 
FeaturePlot(new_obj, 'CCKBR' ) 

saveRDS(new_obj, 'A:/optimal_clustering_05_06_2025/RNA_object_human_names.rds')
marks <- FindAllMarkers(new_obj)

write_tsv(marks, 'A:/cellphonedb_05_12_2025/human_named_DEGs.tsv')
