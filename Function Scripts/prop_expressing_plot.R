...
format_pval = function(p) {
  ...
  gene_prop = ggplot(tog_6_gene, aes(x = Phase, y = n_gene / total_cells)) +
    ...
    labs(x = 'Phase', y = paste0('6_NPO % ', gene, '+')) +
...
plot_proportions_sub_6(sub_6, 'drd3')

saveRDS(plot_proportions_sub_6, 'Functions/prop_expressing_plot.rds')
