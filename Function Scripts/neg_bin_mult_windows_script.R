neg_bin_mult_windows <- function(obj,
                         cluster, 
  ...
  results <- parallelsugar::mclapply(1:index, function(i) {
...
saveRDS(neg_bin_mult_windows, 'Functions/DEG_functions/neg_bin_mult_windows.rds')
