...
#minimal_set.to_csv('C:/Users/Gabe/Desktop/multiome_poa/MERFISH/minimal_set_MI_08_04_2025.csv')
...
###ok so the mutual information approach worked, but the validation failed
## I want to try permuting combinations of n/2 and maybe n/4 of the minimal gene set
## to see how cross valiation fares, I also want to add in the markers I calculated in
## seurat to see how that works
