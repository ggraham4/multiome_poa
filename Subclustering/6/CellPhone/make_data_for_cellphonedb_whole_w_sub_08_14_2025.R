...
#writeMM(human_named@assays$RNA$data, file = 'A:/cellphone_6_08_14_2025/whole_matrix.mtx')
# save gene and cell names
#write(x = rownames(human_named@assays$RNA$data), file = "A:/cellphone_6_08_14_2025/whole_features.tsv")
#write(x = colnames(human_named@assays$RNA$data), file = "A:/cellphone_6_08_14_2025/whole_barcodes.tsv")
...
#write.table(df, file ='A:/cellphone_6_08_14_2025/whole_human_named_meta.tsv', sep = '\t', quote = F, row.names = F)
...
#write.table(fDEGs, file ='A:/cellphone_6_08_14_2025/whole_human_named_DEGs.tsv', sep = '\t', quote = F, row.names = F)
...
for(i in unique(human_named$individual)){
  ...
  meta_path = paste0('A:/cellphone_6_08_14_2025/',i,'/whole_human_named_meta.tsv')
  ...
  file_path = paste0('A:/cellphone_6_08_14_2025/',i,'/whole_DEGs.tsv')
