...
obj_subclustered_11 <- FindSubCluster(obj, 11, 'harmony.wsnn')
...
for (i in 1) { 
  ...
  print(i)
  output <- neg.bin.mult(obj_subclustered_11,
                         cluster =cluster,
                         clustering = 'sub.cluster')
  output$cluster = cluster
    write.csv(output, paste0('/Users/ggraham/Desktop/multiome_poa/DEG Outputs/09_12_2025 11 Subclusters Neg Bin Anova First/cluster_',cluster,'.csv'))
...
for (i in 0:2) {
    cluster = paste0('11_',i)
  print(i)
    data = read.csv(paste0('/Users/ggraham/Desktop/multiome_poa/DEG Outputs/09_12_2025 11 Subclusters Neg Bin Anova First/cluster_',cluster,'.csv'))
...
#write.csv(final_data, 'Subclustering/degs_11_defined_09_12_2025.csv')
