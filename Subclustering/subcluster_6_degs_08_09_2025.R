...
for (i in 0:3) { 
  cluster = paste0('6_',i)
  print(i)
  output <- neg.bin.mult(obj_subclustered_6,
                         cluster =cluster,
                         clustering = 'sub.cluster')
  output$cluster = cluster
    write.csv(output, paste0('/Users/ggraham/Desktop/multiome_poa/DEG Outputs/08_09_2025 6 Subclusters Neg Bin Anova First/cluster_',cluster,'.csv'))
