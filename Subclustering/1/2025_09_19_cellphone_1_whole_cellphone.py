...
cpdb_version = 'v5.0.0'
cpdb_target_dir = os.path.join('A:/cellphone_1_09_19_2025', cpdb_version)
...
import hdf5plugin
obj.write_h5ad('A:/cellphone_1_09_19_2025/whole_normalised_log_counts.h5ad')

## define paths
cpdb_file_path = 'A:/cellphone_1_09_19_2025/v5.0.0/cellphonedb.zip'
meta_file_path = 'A:/cellphone_1_09_19_2025/whole_human_named_meta.tsv' #has been made in R
counts_file_path  = 'A:/cellphone_1_09_19_2025/whole_normalised_log_counts.h5ad' 
out_path = 'A:/cellphone_1_09_19_2025/whole_output/'
degs_file_path = 'A:/cellphone_1_09_19_2025/whole_human_named_DEGs.tsv' #has been made in R
...
for i in set(obj.obs.individual):
    ...
    dir_path = f"A:/cellphone_1_09_19_2025/{i}"
    if not os.path.exists(dir_path):
        os.mkdir(dir_path)
    counts_path = f"A:/cellphone_1_09_19_2025/{i}/whole_normalised_log_counts.h5ad"
...
for i in set(obj.obs.individual):
    if i == 'GH':
        continue
    meta_file_path = f"A:/cellphone_1_09_19_2025/{i}/whole_human_named_meta.tsv"
    metadata = pd.read_csv(meta_file_path, sep = '\t')
    print(metadata.head)
...
for i in set(obj.obs.individual):
    ...
    meta_file_path = f"A:/cellphone_1_09_19_2025/{i}/whole_human_named_meta.tsv"
    counts_path = f"A:/cellphone_1_09_19_2025/{i}/whole_normalised_log_counts.h5ad"
    deg_path = f"A:/cellphone_1_09_19_2025/{i}/whole_DEGs.tsv"
    cpdb_file_path = 'A:/cellphone_1_09_19_2025/v5.0.0/cellphonedb.zip'
    out_path = f"A:/cellphone_1_09_19_2025/whole_output/{i}"
